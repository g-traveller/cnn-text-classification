...
tf.flags.DEFINE_string("training_data_file", "./data/train_data.csv", "Training data path")
...
# Data preprocess
# =======================================================
print("Loading training data and processing...")
data_loader = DataLoader(FLAGS.training_data_file)
train_data, max_sentence_length = data_loader.load()
x = train_data[0]
y = train_data[1]
...
params = {'num_labels' : FLAGS.num_labels, 'max_document_length' : max_sentence_length}
